...
const CheckerWorker_1 = require("./CheckerWorker");
...
class CheckerFacade {
    constructor(options, loggingContext) {
        if (options.checkers.length) {
            this.childProcess = ChildProcessProxy_1.default.create(require.resolve(`./${CheckerWorker_1.CheckerWorker.name}`), loggingContext, options, {}, process.cwd(), CheckerWorker_1.CheckerWorker);
        }
    }
    async dispose() {
...
//# sourceMappingURL=CheckerFacade.js.map