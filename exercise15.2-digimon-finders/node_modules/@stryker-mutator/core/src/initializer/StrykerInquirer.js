...
class StrykerInquirer {
    ...
    async promptTestRunners(options) {
        ...
        if (options.length) {
            ...
            return (_a = options.filter((_) => _.name === answers.testRunner)[0]) !== null && _a !== void 0 ? _a : { name: CommandTestRunner_1.default.runnerName, pkg: null };
        }
        else {
            return { name: CommandTestRunner_1.default.runnerName, pkg: null };
        }
    }
