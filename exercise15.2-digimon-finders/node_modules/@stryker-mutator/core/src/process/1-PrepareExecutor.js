...
class PrepareExecutor {
    ...
    async execute() {
        ...
        const mainInjector = di_1.buildMainInjector(this.injector);
        mainInjector.resolve(di_1.coreTokens.timer).reset();
        ...
        const inputFiles = await mainInjector.injectClass(InputFileResolver_1.default).resolve();
...
PrepareExecutor.inject = plugin_1.tokens(di_1.coreTokens.cliOptions, plugin_1.commonTokens.injector);
//# sourceMappingURL=1-PrepareExecutor.js.map