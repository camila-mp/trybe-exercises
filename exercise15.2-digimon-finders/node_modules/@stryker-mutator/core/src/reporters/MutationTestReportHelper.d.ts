...
import { CompleteDryRunResult, MutantRunResult } from '@stryker-mutator/api/test_runner';
...
export declare class MutationTestReportHelper {
    ...
    private reportOne;
    reportMutantTimeout(mutantWithTestCoverage: MutantTestCoverage): void;
...
//# sourceMappingURL=MutationTestReportHelper.d.ts.map