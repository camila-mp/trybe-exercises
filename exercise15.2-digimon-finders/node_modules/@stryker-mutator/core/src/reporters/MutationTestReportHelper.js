...
const mutantUtils_1 = require("../utils/mutantUtils");
/**
...
class MutationTestReportHelper {
    ...
    reportOne(mutant, additionalFields) {
        ...
        const mutantResult = Object.assign({ id: mutant.id.toString(), location: mutant.location, mutatedLines: mutantUtils_1.mutatedLines(originalFileTextContent, mutant), mutatorName: mutant.mutatorName, originalLines: mutantUtils_1.originalLines(originalFileTextContent, mutant), range: mutant.range, replacement: mutant.replacement, fileName: mutant.fileName, nrOfTestsRan: 0 }, additionalFields);
        this.reporter.onMutantTested(mutantResult);
        return mutantResult;
    }
    reportMutantTimeout(mutantWithTestCoverage) { }
...
//# sourceMappingURL=MutationTestReportHelper.js.map