...
const configLoaders_1 = require("./configLoaders");
const jestOverrideOptions_1 = tslib_1.__importDefault(require("./jestOverrideOptions"));
function jestTestRunnerFactory(injector) {
    return injector
        .provideValue(pluginTokens_1.processEnvToken, process.env)
        .provideValue(pluginTokens_1.jestVersionToken, require('jest/package.json').version)
        .provideFactory(pluginTokens_1.jestTestAdapterToken, jestTestAdapters_1.jestTestAdapterFactory)
        .provideFactory(pluginTokens_1.configLoaderToken, configLoaders_1.configLoaderFactory)
...
class JestTestRunner {
    ...
    mergeConfigSettings(configFromFile, config) {
      ...
      and default (internal) stryker config ${jestOverrideOptions_1.default}`);
        return Object.assign(Object.assign(Object.assign({}, configFromFile), config), jestOverrideOptions_1.default);
    }
}
exports.default = JestTestRunner;
JestTestRunner.inject = plugin_1.tokens(plugin_1.commonTokens.logger, plugin_1.commonTokens.options, pluginTokens_1.processEnvToken, pluginTokens_1.jestTestAdapterToken, pluginTokens_1.configLoaderToken);
